...
class AuthorTableMap extends TableMap
{
     ...
     */
    const CLASS_NAME = 'testpropel.Map.AuthorTableMap';
     ...
     */
    const OM_CLASS = '\\testpropel\\Author';

    /**
     * A class that can be returned by this tableMap
     */
    const CLASS_DEFAULT = 'testpropel.Author';
    ...
    public function initialize()
    {
        ...
        $this->setClassName('\\testpropel\\Author');
     ...
     */
     public static function doDelete($values, ConnectionInterface $con = null)
     {
        ...
        if ($values instanceof Criteria) {
            // rename for clarity
            $criteria = $values;
        } elseif ($values instanceof \testpropel\Author) { // it's a model object
