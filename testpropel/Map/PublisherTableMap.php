...
use testpropel\Publisher;
use testpropel\PublisherQuery;
...
class PublisherTableMap extends TableMap
{
     ...
     */
    const CLASS_NAME = 'testpropel.Map.PublisherTableMap';
     ...
     */
    const OM_CLASS = '\\testpropel\\Publisher';

    /**
     * A class that can be returned by this tableMap
     */
    const CLASS_DEFAULT = 'testpropel.Publisher';
    ...
    public function initialize()
    {
        ...
        $this->setClassName('\\testpropel\\Publisher');
    ...
    {
        $this->addRelation('Book', '\\testpropel\\Book', RelationMap::ONE_TO_MANY, array (
  0 =>
  array (
    0 => ':publisher_id',
    1 => ':id',
     ...
     */
     public static function doDelete($values, ConnectionInterface $con = null)
     {
        ...
        if ($values instanceof Criteria) {
            // rename for clarity
            $criteria = $values;
        } elseif ($values instanceof \testpropel\Publisher) { // it's a model object
