...
class BookTableMap extends TableMap
{
     ...
     */
    const CLASS_NAME = 'testpropel.Map.BookTableMap';
     ...
     */
    const OM_CLASS = '\\testpropel\\Book';

    /**
     * A class that can be returned by this tableMap
     */
    const CLASS_DEFAULT = 'testpropel.Book';
    ...
    public function initialize()
    {
        ...
        $this->setClassName('\\testpropel\\Book');
        $this->setPackage('testpropel');
    ...
    {
        $this->addRelation('Publisher', '\\testpropel\\Publisher', RelationMap::MANY_TO_ONE, array (
  0 =>
  array (
    0 => ':publisher_id',
    1 => ':id',
        ...
        $this->addRelation('Author', '\\testpropel\\Author', RelationMap::MANY_TO_ONE, array (
  0 =>
  array (
    0 => ':author_id',
    1 => ':id',
     ...
     */
     public static function doDelete($values, ConnectionInterface $con = null)
     {
        ...
        if ($values instanceof Criteria) {
            // rename for clarity
            $criteria = $values;
        } elseif ($values instanceof \testpropel\Book) { // it's a model object
