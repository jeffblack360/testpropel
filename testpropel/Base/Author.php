...
use testpropel\Author as ChildAuthor;
use testpropel\AuthorQuery as ChildAuthorQuery;
use testpropel\Book as ChildBook;
use testpropel\BookQuery as ChildBookQuery;
use testpropel\Map\AuthorTableMap;
...
abstract class Author implements ActiveRecordInterface
{
     ...
     * TableMap class name
     */
    const TABLE_MAP = '\\testpropel\\Map\\AuthorTableMap';
    ...
    /**
     * Initializes internal state of testpropel\Base\Author object.
     */
     ...
     * @return $this|\testpropel\Author The current object (for fluent API support)
     */
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            throw new PropelException(sprintf('Error populating %s object', '\\testpropel\\Author'), 0, $e);
        }
    }
     ...
     * @param string $keyType The type of keys the array uses.
     *
     * @return $this|\testpropel\Author The current object, for fluid interface
     */
     ...
     * objects.
     *
     * @param      object $copyObj An object of \testpropel\Author (or compatible) type.
     ...
     *
     * @param  boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return \testpropel\Author Clone of current object.
     * @throws PropelException
     */
