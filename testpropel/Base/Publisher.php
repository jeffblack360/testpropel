...
use testpropel\Book as ChildBook;
use testpropel\BookQuery as ChildBookQuery;
use testpropel\Publisher as ChildPublisher;
use testpropel\PublisherQuery as ChildPublisherQuery;
use testpropel\Map\PublisherTableMap;
 ...
 *
 *
* @package    propel.generator.testpropel.Base
*/
abstract class Publisher implements ActiveRecordInterface
{
     ...
     * TableMap class name
     */
    const TABLE_MAP = '\\testpropel\\Map\\PublisherTableMap';
    ...
    /**
     * Initializes internal state of testpropel\Base\Publisher object.
     */
     ...
     * @return $this|\testpropel\Publisher The current object (for fluent API support)
     */
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            throw new PropelException(sprintf('Error populating %s object', '\\testpropel\\Publisher'), 0, $e);
        }
    }
     ...
     *                TableMap::TYPE_COLNAME, TableMap::TYPE_FIELDNAME, TableMap::TYPE_NUM.
     *                Defaults to TableMap::TYPE_PHPNAME.
     * @return $this|\testpropel\Publisher
     */
     ...
     * @param string $keyType The type of keys the array uses.
     *
     * @return $this|\testpropel\Publisher The current object, for fluid interface
     */
     ...
     * objects.
     *
     * @param      object $copyObj An object of \testpropel\Publisher (or compatible) type.
     ...
     *
     * @param  boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return \testpropel\Publisher Clone of current object.
     * @throws PropelException
     */
    ...
    public function initBooks($overrideExisting = true)
    {
        ...
        $this->collBooks->setModel('\testpropel\Book');
    }
